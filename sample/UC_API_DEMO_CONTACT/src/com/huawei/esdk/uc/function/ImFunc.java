...
//        // {
//        // CustomBroadcastConst.ACTION_DELETE_ROAMING_MESSAGE,
//        // CustomBroadcastConst.ACTION_QUERY_ROAMING_MESSAGE,
//        // };
//        //
...
//    }
//
//    // 这个是仿照espace的实现逻辑来做的消息接收
//    // private final BaseReceiver localReceiver = new BaseReceiver()
//    // {
//    // @Override
//    // public void onReceive(String action, BaseData data)
//    // {
//    // if (data == null || !(data instanceof ReceiveData))
//    // {
//    // return;
//    // }
//    // final ReceiveData d = (ReceiveData) data;
//    // ThreadManager.getInstance().addLargeMessageThread(new Runnable()
//    // {
//    // @Override
//    // public void run()
//    // {
//    //
//    // if (d.action.equals(CustomBroadcastConst.ACTION_QUERY_ROAMING_MESSAGE))
//    // //处理接收到的漫游消息
//    // {
//    // handlerHistoryMessageResponse(d);
//    // }
//    //
//    // }
//    // });
...
//     * @return
//     */
//    private boolean isImMessage(int type)
//    {
...
//     * @return
//     */
//    private boolean isGroupMessage(int type)
//    {
...
//                        + chatResp.getMsgId());
//
//                if (!StringUtil.isStringEmpty(chatResp.getMsgId()))
//                {
...
//     * @param intent
//     */
//    public void handleInComingMessage(Intent intent)
//    {
...
//            account = msg.getToId();
//        }
//        else if (!StringUtil.isStringEmpty(userName))
//        {
...
//            return;
//        }
//        InstantMessageDao.deleteMore(account, msg.getMsgType());
//
...
//
//        if (null != pc && StringUtil.isStringEmpty(pc.getName()))
//        {
...
//                null);
//        if (!StringUtil.isStringEmpty(displayName))
//        {
//            msg.setNickname(displayName);
//        }
//        if (StringUtil.isStringEmpty(msg.getNickname()))
//        {
...
//    {
//        if (StringUtil.isStringEmpty(msg.getFrom())
//                || StringUtil.isStringEmpty(msg.getTo()))
//        {
//            return false;
//        }
//        if (!StringUtil.isStringEmpty(msg.getMessageId()))
//        {
...
//    }
//
//    private int getMarkType(int msgType)
//    {
...
//        if (null != proxy && !StringUtil.isStringEmpty(msgId))
//        {
...
//    {
//        return InstantMessageDao.getUnReadMsgCount(chatId, msgType);
//    }
//
//    /**
//     * 获取某个聊天的未读消息
...
//        if (StringUtil.isNotEmpty(info.getMessageId()))
//        {
...
//                .getEspaceNumber();
//
//        if (StringUtil.isStringEmpty(selfAccount))
//        {
...
//                {
//                    UmFunc.getIns().downloadFile(im, im.getMediaRes());
//                }
//
...
//        String fileName = com.huawei.utils.FileUtil.getFileNameWithSha1(sha1,
//                path);
//        String thePath = UmUtil.createResPath(MediaResource.MEDIA_PICTURE,
//                fileName, UmFunc.JPG);
//
//        if (StringUtil.isStringEmpty(sha1) || StringUtil.isStringEmpty(thePath))
//        {
//            return null;
//        }
//
//        // 压缩图片,压缩不成功，可能图片很小不需要压缩。直接返回path。
//        if (PhotoUtil.zoomPicture(path, thePath, UmFunc.MAXPICSIZE)
//                && !(thePath.toLowerCase(Locale.ENGLISH).endsWith(UmFunc.JPG)))
//        {
//            // 对于不是jpg结尾的图片，需要重新进行处理
//            String jpgFileName = sha1 + UmFunc.DOT + UmFunc.JPG;
...
//    {
//        ToastUtil.showToast(UCAPIApp.getApp(), R.string.video_max_tip);
//    }
//
//    /**
//     * 处理多媒体消息发送
...
//        }
//
//        String name = StringUtil.isStringEmpty(fileName) ? uri
...
//    }
//
//    private int getMarkTag(int msgType)
//    {
...
//                }
//
//                String suffix = UmFunc.MP4; // ChatUtil.getMeidaSuffix(mediaType
//                                            // == MediaResource.MEDIA_VIDEO);
//                String fileName = sha1 + UmFunc.DOT + suffix;
...
//
//                // 移动文件到新创建的目录
//                boolean move = com.huawei.utils.FileUtil
...
//     * 
//     * */
//    public void handleUmMsgUploadProcessUpdate(UmFunc.UmReceiveData data)
//    {
//        if (data == null)
//        {
//            return;
...
//     * 
//     * */
//    public void handleUmMsgUploadFileFinish(UmFunc.UmReceiveData data)
//    {
//        android.os.Message msg = new android.os.Message();
//        msg.arg1 = 0;
...
//     * 
//     * */
//    public void handleUmMsgDownloadProcessUpdate(UmFunc.UmReceiveData data)
//    {
//        if (data == null)
//        {
//            return;
