...
import com.huawei.esdk.uc.demo.conf.call.MediaActivity;
import com.huawei.esdk.uc.demo.conf.self.SelfInfoUtil;
import com.huawei.esdk.uc.demo.conf.utils.DeviceUtil;
...
public class VoipFunc extends BaseBroadcast
{
	...
	public void showMediaActivity(boolean needMakeCall, String callNum,
			String displayName, PersonalContact contact)
	{
	...
	{
		//TODO
		String tel = callSession.getCallerNumber();/*.getCalleeNumber();*/
