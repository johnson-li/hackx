...
public class ConfListAdapter extends BaseAdapter
{
	...
	private static int[] confItemResouces = { R.drawable.bg_item_selector,
			R.drawable.bg_item_selector, R.drawable.conf_begining_select,
			R.drawable.bg_item_selector };

	private static int[] confTxtColorRes = { R.color.item_member,
			R.color.item_member, R.color.white, R.color.chat_item_tag };
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		holder.confIcon.setImageResource(confIconResources[conferenceEntity
				.getType() - 1][status]);
