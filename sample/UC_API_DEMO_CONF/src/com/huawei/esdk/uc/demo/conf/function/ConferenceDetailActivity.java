...
import com.huawei.esdk.uc.demo.IntentData;
import com.huawei.esdk.uc.demo.conf.R;
import com.huawei.esdk.uc.demo.conf.application.UCAPIApp;
import com.huawei.esdk.uc.demo.conf.function.data.AddMemberEntity;
import com.huawei.esdk.uc.demo.conf.function.data.MemberContant;
...
public class ConferenceDetailActivity extends Activity
{
    ...
    {
//        boolean checkInvalid(BaseData data)
//        {
//            return data == null || !(data instanceof ConferenceFunc.ConferenceReceiveData);
//        }

//        boolean checkNoInvalid(ConferenceFunc.ConferenceReceiveData d)
//        {
//            return null == d.confId || !d.confId.equals(getConfId());
//        }
