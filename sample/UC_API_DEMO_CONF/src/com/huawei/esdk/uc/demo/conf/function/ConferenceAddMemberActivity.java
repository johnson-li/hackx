...
import com.huawei.esdk.uc.demo.conf.group.ContactAddView;
...
public class ConferenceAddMemberActivity extends Activity implements
		MemberAddHandler
{
	...
	private void initView()
	{
		...
		if (confId != null)
		{
			inConfMembers = (List<ConferenceMemberEntity>) getIntent()
	...
	public ConferenceMemberEntity getConfMemberEntity(PersonalContact contact)
	{
		...
		String number = SelfDataHandler.getIns().getSelfData().getCallbackNmb();
