...
public class UmParser
{
	...
	private static final int[] MEDIA_DRAWABLE_FAIL = { 0,
	...
	private static final int[] MEDIA_DRAWABLE_COMMON = { 0,
	...
	private static final int[] MEDIA_DRAWABLE_UNREAD = { 0,
	...
	public SpannableString getUmSpannableString(InstantMessage msg)
	{
		...
		try
		{
			...
			ImageSpan image = new ImageSpan(UCAPIApp.getApp()
					.getCurActivity(), resid);
			result.setSpan(image, 0, msg.getContent().length(),
