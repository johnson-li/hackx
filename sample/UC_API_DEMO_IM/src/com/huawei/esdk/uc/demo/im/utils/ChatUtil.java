...
import com.huawei.esdk.uc.demo.im.VideoRecorderActivity;
...
public class ChatUtil {
    ...
    {
        String picPath = UmUtil.createPhotoPath(UmImConstant.JPG);
    ...
    {
        String path = UmUtil.createPhotoPath(UmImConstant.MP4);
