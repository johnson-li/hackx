package com.huawei.esdk.uc.demo.im.login;
...
import com.huawei.esdk.uc.demo.im.goim.ToIMActivity;
import com.huawei.esdk.uc.demo.im.self.SelfInfoUtil;
import com.huawei.esdk.uc.demo.im.utils.TestData;
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			if (CustomBroadcastConst.ACTION_CONNECT_TO_SERVER.equals(action))
			{
				...
				if (respData)
				{
					...
					startActivity(new Intent(LoginActivity.this, ToIMActivity.class));
