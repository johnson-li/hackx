...
import com.huawei.esdk.uc.demo.im.adapter.CirclePictureScanAdapter;
import com.huawei.esdk.uc.demo.im.adapter.ImageAdapter;
import com.huawei.esdk.uc.demo.im.adapter.MultiSendAdapter;
import com.huawei.esdk.uc.demo.im.adapter.PictureScanAdapter;
import com.huawei.esdk.uc.demo.im.adapter.SimplePictureScanAdapter;
...
import com.huawei.esdk.uc.demo.im.widget.ProcessDialog;
...
//        dialog.show();
    ...
    private void prepareViewForSend()
    {
        ...
        newPath = UmUtil.createTempResPath(UmImConstant.JPG);
        updateSendButton();
        //图片旋转压缩后显示。
        if (isChoose)
        {
    ...
    private void operatePicture(final String oldPath, final String newPath)
    {
        ...
        try
        {
            new AsyncTask<Integer, Integer, Object>()
            {
                ...
                {
                    PhotoUtil.zoomPicture(oldPath, newPath, true,UmImConstant.MAXPICSIZE);
                    return null;
                }
