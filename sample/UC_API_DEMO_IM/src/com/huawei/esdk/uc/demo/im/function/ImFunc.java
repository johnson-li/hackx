...
import com.huawei.esdk.uc.demo.im.FuncResultCode;
...
import com.huawei.esdk.uc.demo.im.data.GetHistoryMessageInfo;
import com.huawei.esdk.uc.demo.im.utils.ChatUtil;
import com.huawei.esdk.uc.demo.im.utils.DialogUtil;
import com.huawei.esdk.uc.demo.im.utils.FileUtil;
...
//	            extraParam = UmUtil.genExtraParam(uri.getPath());
	        ...
	        if (path == null || !(new File(path).exists()))
	        {
	          ...
	          /** by lwx 303895 因MediaResource 对象总是 Imfunc..报错没有序列化*/
	        ...
	        //代码修改 bylwx302895
//	        String name = StringUtil.isStringEmpty(fileName) ? uri.getLastPathSegment() : fileName;
