...
import com.huawei.esdk.uc.demo.camera.FaceTrackerActivity;
...
//				ShowPrompt("failed login");
  ...
  protected void initCompenent() {
    ...
    serverIP = sharedInfo.getString("serverip", "222.92.146.246");
    ...
    btnCamera.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        Intent intent = new Intent(LoginActivity.this, FaceTrackerActivity.class);
